...
Mᴀᴅᴇ ʙʏ <a href="https://github.com/LEGEND-ANKIT">©LEGEND-ANKIT™</a>
"""
START_BUTTONS = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton('🔰Developer🔰', url='https://github.com/LEGEND-ANKIT'),
            InlineKeyboardButton('🔰©LEGEND-ANKIT™🔰', url='https://github.com/LEGEND-ANKIT'),
        ]
    ]
)
CALCULATE_TEXT = "Mᴀᴅᴇ Bʏ 🔰©LEGEND-ANKIT™🔰"
...
@Bot.on_message(filters.private & filters.command(["calc", "calculate", "calculator", "legend", "ankit"]))
